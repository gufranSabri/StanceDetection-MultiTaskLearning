...
def main(args):
    ...
    torch.save(model.state_dict(), f"./models/{args.model}_fs.{args.first_task}_{ensm}_{wsm}_berts.{args.bert_models}_pool.{args.pooling}_bi.{args.use_bi}_gru.{args.use_gru}_stanceAcc{best_valid_stance_acc:.6f}.pt")
